...
public class WekaExtractor {
	...
	public static List<List<ClassifierData>> computeWeka(int iterations, String projName) throws Exception {
		...
		for(i=1;i<iterations;i++){		
			...
			basicRandomFor.setTrainingPerc(100.0*basicTrain.numInstances()/(basicTrain.numInstances()+basicTes.numInstances()));
			...
			basicNaiveBa.setTrainingPerc(100.0*basicTrain.numInstances()/(basicTrain.numInstances()+basicTes.numInstances()));			
			...
			basicIbk.setTrainingPerc(100.0*basicTrain.numInstances()/(basicTrain.numInstances()+basicTes.numInstances()));
			...
			featureRandomFor.setTrainingPerc(100.0*featureTrain.numInstances()/(featureTrain.numInstances()+featureTest.numInstances()));
			...
			featureNaiveBay.setTrainingPerc(100.0*featureTrain.numInstances()/(featureTrain.numInstances()+featureTest.numInstances()));
			...
			featureIBk.setTrainingPerc(100.0*featureTrain.numInstances()/(featureTrain.numInstances()+featureTest.numInstances()));
			...
			samplRandomFor.setTrainingPerc(100.0*basicTrain.numInstances()/(basicTrain.numInstances()+basicTes.numInstances()));
			...
			samplNaiveBay.setTrainingPerc(100.0*basicTrain.numInstances()/(basicTrain.numInstances()+basicTes.numInstances()));
			...
			samplIBk.setTrainingPerc(100.0*basicTrain.numInstances()/(basicTrain.numInstances()+basicTes.numInstances()));
			...
			costSensRandomFor.setTrainingPerc(100.0*basicTrain.numInstances()/(basicTrain.numInstances()+basicTes.numInstances()));
			...
			costSensNaiveBa.setTrainingPerc(100.0*basicTrain.numInstances()/(basicTrain.numInstances()+basicTes.numInstances()));
			...
			costSensIBk.setTrainingPerc(100.0*basicTrain.numInstances()/(basicTrain.numInstances()+basicTes.numInstances()));
	        ...
	        featSamplRandomFor.setTrainingPerc(100.0*featureTrain.numInstances()/(featureTrain.numInstances()+featureTest.numInstances()));
		    ...
		    featSamplNaive.setTrainingPerc(100.0*featureTrain.numInstances()/(featureTrain.numInstances()+featureTest.numInstances()));
		    ...
		    featSamplIBk.setTrainingPerc(100.0*featureTrain.numInstances()/(featureTrain.numInstances()+featureTest.numInstances()));
		    ...
		    featCostRandomFor.setTrainingPerc(100.0*featureTrain.numInstances()/(featureTrain.numInstances()+featureTest.numInstances()));
		    ...
		    featCostNaive.setTrainingPerc(100.0*featureTrain.numInstances()/(featureTrain.numInstances()+featureTest.numInstances()));
		    ...
		    featCostIBk.setTrainingPerc(100.0*featureTrain.numInstances()/(featureTrain.numInstances()+featureTest.numInstances()));
